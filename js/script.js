...
/* Packages carousel — mobile-only auto-rotate + arrows + dots */
(function () {
  'use strict';

  var carousel = document.querySelector('[data-packages-carousel]');
  if (!carousel) return;

  var track = carousel.querySelector('.packages-carousel__track');
  if (!track) return;

  var slides = Array.prototype.slice.call(track.children);
  if (slides.length < 2) return;

  var dots = Array.prototype.slice.call(carousel.querySelectorAll('.packages-carousel__dot'));
...
(function () {
  ...
  if (!carousel) return;
  var track = carousel.querySelector('.schools-who-carousel__track');
  var slides = Array.prototype.slice.call(track.children);
  var dots = Array.prototype.slice.call(carousel.querySelectorAll('.schools-who-carousel__dot'));
  var prevBtn = carousel.querySelector('.schools-who-carousel__btn--prev');
  var nextBtn = carousel.querySelector('.schools-who-carousel__btn--next');
  var current = 0;
  var autoTimer = null;
  ...
  if (prevBtn) prevBtn.addEventListener('click', function () { killAutoPlay(); goTo(current - 1, true); });
  if (nextBtn) nextBtn.addEventListener('click', function () { killAutoPlay(); goTo(current + 1, true); });
...
(function () {
  ...
  var prevBtn = carousel.querySelector('.schools-programmes-carousel__btn--prev');
  var nextBtn = carousel.querySelector('.schools-programmes-carousel__btn--next');
  var current = 0;
  var autoTimer = null;
...
(function () {
  ...
  if (!carousel) return;
  var track = carousel.querySelector('.audience-carousel__track');
  var slides = Array.prototype.slice.call(track.children);
  var dots = Array.prototype.slice.call(carousel.querySelectorAll('.audience-carousel__dot'));
  var prevBtn = carousel.querySelector('.audience-carousel__btn--prev');
  var nextBtn = carousel.querySelector('.audience-carousel__btn--next');
  var current = 0;
  var autoTimer = null;
...
(function () {
  ...
  if (!carousel) return;
  var track = carousel.querySelector('.pillars-carousel__track');
  var slides = Array.prototype.slice.call(track.children);
  var dots = Array.prototype.slice.call(carousel.querySelectorAll('.pillars-carousel__dot'));
  var prevBtn = carousel.querySelector('.pillars-carousel__btn--prev');
  var nextBtn = carousel.querySelector('.pillars-carousel__btn--next');
  var current = 0;
  var autoTimer = null;
